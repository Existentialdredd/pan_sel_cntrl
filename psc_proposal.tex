...
%
Now having estimates of all error terms, I construct the following estimates of the primary equation coefficients. \\
%
...
%
 Let $\hat{\phi} = diag\big( \{\hat{\phi}_t\}_{c+1}^T \big)$ Calculate $\hat{\beta}_1$ as follows,  
    \begin{align*} 
